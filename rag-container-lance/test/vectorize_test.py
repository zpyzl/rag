...
# params = {'file_path':'/data/chat-test/uploads/2025/06/09/rag.docx',"file_name":'rag.docx',"org_list":"o1,o2","person_list":"p1,p2","secret_level":"s1"}
params = {'file_path':'D:\\rag.docx',"file_name":'rag.docx',"org_list":"o1,o2","person_list":"p1,p2","secret_level":"s1"}
r = requests.post(f'http://{test_ip}:5003/vectorize', json=params)
print(r)
if r:
    print(r.text)